...
var ctrlAir = require('../controllers/air');
...
router.get('/script/:path',ctrlAir.script);
router.get('/windspeed/:year',ctrlAir.windspeed);
router.get('/temperature/:from/:to',ctrlAir.temperature);
router.get('/time/:year',ctrlAir.time);
router.get('/air/:fromYear/:toYear',ctrlAir.sendList);
router.get('/airCity/:city',ctrlAir.city);
